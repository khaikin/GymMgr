...
namespace GymDal
{
    ...
    public class EFRepository<TC> : IDisposable, IRepository where TC : DbContext
    {
        ...
        public void Update<TE>(TE oldEntity, TE newEntity) where TE : class
        {

            DataContext.Entry(oldEntity).CurrentValues.SetValues(newEntity);
        }
    ...
    public interface IRepository
    {
        ...
        void Update<TE>(TE oldE,TE newE) where TE : class;
        void Commit();
    }
}
